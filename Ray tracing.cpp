...
int main() {
	...
	vector coords0_menu(450, 0);
	vector coords1_menu(1000, 450);

	vector coords0_window = coords0_scene;
	vector coords1_window = coords1_menu;

	Window window(coords0_window, coords1_window, coords0_scene, coords1_scene, 1, 1);
	...
	Canvas canvas(coords0_menu, coords1_menu, Color(84, 94, 140), Color(84, 94, 140));
	canvas.draw_canvas();

	ManagerButton manager_of_buttons;

	manager_of_buttons.add(new SpherePole(vector(730, 50), vector(980, 130), dynamic_cast<Sphere*>(arr_of_obj[0]), Color(233, 236, 246), Color(179, 175, 191), true));
	manager_of_buttons.add(new PlanePole(vector(730, 140), vector(980, 220), dynamic_cast<Plane*>(arr_of_obj[5]), Color(233, 236, 246), Color(179, 175, 191), true));
	//manager_of_buttons.add(new RectanPole(vector(730, 230), vector(980, 350), dynamic_cast<Rectan*>(arr_of_obj[6]), Color(233, 236, 246), Color(179, 175, 191), true));
	manager_of_buttons.add(new ParallelepipedPole(vector(730, 230), vector(980, 385), dynamic_cast<Parallelepiped*>(arr_of_obj[7]), Color(233, 236, 246), Color(179, 175, 191), true));
...
void add_poles(HDC* pages, Object* arr_of_obj, const vector& coords0_menu, const vector& coords1_menu) {
	double width = coords1_menu.x_ - coords0_menu.x_;
	double high = coords1_menu.y_ - coords0_menu.y_;
	HDC page = txCreateCompatibleDC(width, high);
